...
public abstract class TypedModifiable extends TypedResource implements Modifiable {
	private static final long serialVersionUID = 8050024073339824076L;
	private boolean modified = false;
	protected TypedModifiable(File f, MapEditor e){super(f,e);}
	...
	public void save() throws Exception {super.save(); setModified(false);}
	public void deferredRead(File f) throws Exception {super.deferredRead(f); setModified(false);}
}
