...
class Character extends Sprite {
	...
	public var equip:Array<Equipment>; public var weapon:Weapon; public var spell:Spell; public var level(default,null):Int;
	...
	public function clone():Character {
		...
		c.weapon = weapon; for(i in 0...equip.length) c.equip[i] = equip[i]; c.spell = spell; c.resetDefense(); return c;
	}
	...
	public inline function getSkinColor():Int {return CharSheet.indexOf(SKIN_MAT, skin_mat);}
	...
	public inline function getHairColor():Int {return CharSheet.indexOf(HAIR_MAT, hair_mat);}
	...
	public inline function getEyeColor():Int {return CharSheet.indexOf(EYES_MAT, eyes_mat);}
	...
	private function renderBitmap():Void {
		...
		else if(hair != null && equip[HEAD] == Equipment.HELMS[6]){
			var _x:Int = DEATH_ST%19, _y:Int = Std.int(DEATH_ST/19);
			bitmap.draw(hair, null, hair_mat, null, new Rectangle(_x*64, _y*64, (N_FRAMES-DEATH_ST)*64, 64));
