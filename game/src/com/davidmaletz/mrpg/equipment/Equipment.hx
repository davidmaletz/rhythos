...
class Equipment {
	...
	public static var WEAPONS:Array<Weapon>;
	public static var PANTS:Array<Equipment>;
	public static var SHIRTS:Array<Equipment>;
	public static var HELMS:Array<Equipment>;
	
	public static var WEAPON_NAMES:Array<String>;
	public static var PANT_NAMES:Array<String>;
	public static var SHIRT_NAMES:Array<String>;
	public static var HELM_NAMES:Array<String>;
	
	public static var WEAPON_COSTS:Array<Int>;
	public static var PANT_COSTS:Array<Int>;
	public static var SHIRT_COSTS:Array<Int>;
	public static var HELM_COSTS:Array<Int>;
}
